...
const Cart = () => {
  return (
    <div className="relative w-full sm:w-[300px] h-fit p-3 bg-primary-black m-1 rounded-lg font-MintGrotesk font-bold">
      ...
      <span className="bg-primary-black">
        ...
        <div className="pt-3">
          ...
          <div className="w-full flex justify-between items-center">
            <a
              href="/product"
              className="border-primary-white relative flex items-center border px-3 py-[10px] leading-[11px] res-text-lg group w-fit"
            >
              <span className="z-10 group-hover:text-primary-black text-primary-white">
                Buy
              </span>
